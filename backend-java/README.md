...
O diagrama **Mermaid** completo (`classDiagram`) está centralizado em [**`docs/diagram_uml.md`**](../docs/diagram_uml.md) (visão dos componentes, ingestão mock JSONL e REST). Para exportar PNG/SVG, use preview com Mermaid ou o [Mermaid Live Editor](https://mermaid.live).
